...
<html lang="fr">
    ...
    <body>
        <div id="global">
            <header>
                <a href="index.php"><h1 id="titreBlog">Le site de Marwane Rezgui v2.0.0.2</h1></a>
                <p>Version avec démarrage de session pour accès aux opérations de gestion</p>
                <a href="<?= $utilisateur != '' ? 'Admin' : ''; ?>Places">
                    <h4>Afficher toutes les places de toutes les transactions</h4>
                </a>
                <a href="apropos">
                    <h4>À propos</h4>
                </a>
